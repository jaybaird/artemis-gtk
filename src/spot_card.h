...
void
spot_card_set_corner_image_visible(SpotCard *self, gboolean visible);

void
spot_card_update_pinned_state(SpotCard *self);
void
spot_card_update_hunted_state(SpotCard *self);
